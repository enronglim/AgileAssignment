...
Public Class PaymentDetailForm
    ...
    Private Sub dgvBillingRecordPaymentDetail_CellContentClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgvBillingRecordPaymentDetail.RowHeaderMouseDoubleClick
        ...
        If selection = 1 Then
            WarrantyClaimInsertForm.txtPaymentNo.Text = PaymentHistoryRetrieveForm.paymentID.ToString
            WarrantyClaimInsertForm.txtProductClaim.Text = br.ItemStorage.stockName.ToString
            WarrantyClaimInsertForm.txtInventoryID.Text = br.ItemStorage.inventoryID.ToString
            WarrantyClaimInsertForm.txtCustomerName.Text = py.Bill.Customer.name.ToString
            WarrantyClaimInsertForm.mskCustomerIc.Text = py.Bill.Customer.customerIC.ToString
            WarrantyClaimInsertForm.txtCustomerContact.Text = py.Bill.Customer.contactNo.ToString
            WarrantyClaimInsertForm.billingRecordItemQuantity = CInt(br.quantity)
            WarrantyClaimInsertForm.txtClaimReason.ReadOnly = False
            WarrantyClaimInsertForm.txtQtyClaim.ReadOnly = False
            WarrantyClaimInsertForm.lblPaymentEmpty.Visible = False
            Me.Close()
            PaymentHistoryRetrieveForm.Close()
        End If
        selection = 0
